    ...
    private String getRemediesForDisease(String diseaseName) {
        switch (diseaseName) {
            ...
            case "Apple___Cedar_apple_rust":
                return "Remove nearby cedar trees if possible, and use fungicides to protect trees during wet spring weather like 1) Mancozeb: Fungicide effective against apple cedar rust, with around 80-90% control rate.\n" +
                        "2) Myclobutanil: Another fungicide option, providing approximately 70-80% efficacy against apple cedar rust.\n" +
                        "3) Thiophanate-methyl: Effective chemical control option, achieving control rates of 70-85% against apple cedar rust.";
            ...
            case "Corn_(maize)___Cercospora_leaf_spot Gray_leaf_spot":
                return "Apply fungicides that are effective against Cercospora species.To combat Corn Common Grey Leaf Spot, utilize fungicides like triazole (0.05-0.1%) or strobilurin (0.05-0.1%), alongside balanced fertilizers with higher potassium content (2-3%) to boost plant resilience.";
            case "Corn_(maize)___Common_rust_":
                return "Plant resistant varieties and apply fungicides if necessary.To manage Corn Common Rust, use fungicides like triazole (0.05-0.1%) or strobilurin (0.05-0.1%), along with balanced fertilizers containing higher levels of potassium (2-3%) for enhanced plant immunity.";
            case "Corn_(maize)___Northern_Leaf_Blight":
                return "Use resistant corn varieties and apply fungicides as needed  like azoxystrobin or pyraclostrobin can control northern leaf blight in corn, with efficacy ranging from 75-100%.";
            case "Corn_(maize)___healthy":
                return "No treatment needed for healthy plants.";
            case "Grape___Black_rot":
                return "For Grape Black Rot, employ systemic fungicides like pyraclostrobin (0.05-0.1%), copper-based fungicides (1-2%), and potassium-rich fertilizers (2-3%) to bolster plant defenses. Consistent application is paramount for efficacy.Apply fungicides and ensure good air circulation through pruning.";
            case "Grape___Esca_(Black_Measles)":
                return "Prune out infected wood and apply wound protectants to prevent infection.To address Grape Esca, use systemic fungicides like fosetyl-aluminum (0.05-0.1%), copper-based fungicides (1-2%), and potassium-rich fertilizers (2-3%) to enhance plant resilience. Regular application is essential for control.";
            case "Grape___Leaf_blight_(Isariopsis_Leaf_Spot)":
                return "Apply copper-based fungicides and ensure proper canopy management.To manage Grape Leaf Blight, apply copper-based fungicides (1-2%), systemic fungicides like mancozeb (0.05-0.1%), and balanced fertilizers with higher potassium content (2-3%) to strengthen plant immunity. Regular treatment is vital.";
            ...
            case "Peach___Bacterial_spot":
                return "For Peach Bacterial Spot, utilize copper-based bactericides (1-2%), systemic bactericides like streptomycin (0.05-0.1%), and potassium-rich fertilizers (2-3%) to enhance plant defense mechanisms. Consistent application is essential.Apply copper-based bactericides early in the season and improve tree nutrition.";
            case "Peach___healthy":
                return "No treatment needed for healthy plants.";
            case "Pepper,_bell___Bacterial_spot":
                return "Use pathogen-free seeds, apply copper sprays, and practice crop rotation.To combat Bell Pepper Bacterial Spot, use copper-based bactericides (1-2%), systemic bactericides like streptomycin (0.05-0.1%), and potassium-rich fertilizers (2-3%) to bolster plant resilience. Regular application is crucial.";
            case "Pepper,_bell___healthy":
                return "No treatment needed for healthy plants.";
            case "Potato___Early_blight":
                return "To address Potato Early Blight, use copper-based fungicides (1-2%), systemic fungicides like chlorothalonil (0.05-0.1%), and balanced fertilizers with higher potassium levels (2-3%) to boost plant immunity. Regular application is crucial.Use fungicide sprays and rotate crops to prevent disease.";
            case "Potato___Late_blight":
                return "For Potato Late Blight, employ copper-based fungicides (1-2%), systemic fungicides like mancozeb (0.05-0.1%), and potassium-rich fertilizers (2-3%) to enhance plant defenses. Consistent application is paramount for effectiveness.Apply fungicides, practice crop rotation, and destroy infected plants.";
            ...
            case "Squash___Powdery_mildew":
                return "Use fungicide sprays like Tebuconazole 50.0% WG, Trifloxystrobin 25.0% WG; and plant resistant varieties if available.";
            case "Strawberry___Leaf_scorch":
                return "Remove infected leaves and apply fungicides to protect new foliage Fungicides like azoxystrobin or boscalid are effective against strawberry leaf scorch in corn.";
            case "Strawberry___healthy":
                return "No treatment needed for healthy plants.";
            case "Tomato___Bacterial_spot":
                return "Use disease-free seeds, apply copper-based fungicides, and avoid overhead watering.To address Tomato Bacterial Spot, employ copper-based bactericides (1-2%), systemic bactericides like streptomycin (0.05-0.1%), and potassium-rich fertilizers (2-3%) to boost plant defense mechanisms. Consistent application is vital.";
            case "Tomato___Early_blight":
                return "Apply fungicides and remove affected leaves to reduce the spread.For Tomato Early Blight, use copper-based fungicides (1-2%), systemic fungicides like chlorothalonil (0.05-0.1%), and potassium-rich fertilizers (2-3%) to enhance plant resilience. Regular application is crucial for effectiveness.";
            case "Tomato___Late_blight":
                return "Use resistant varieties, apply fungicides, and ensure good air circulation.Chemical remedies for Tomato Late Blight include copper-based fungicides (1-2%), systemic fungicides such as mancozeb (0.05-0.1%), and potassium-rich fertilizers (2-3%) to bolster plant defenses. Consistent application is critical.";
            case "Tomato___Leaf_Mold":
                return "Improve air circulation in the greenhouse and apply fungicides.Chemical remedies for Tomato Leaf Mold include copper-based fungicides (1-2%), systemic fungicides like chlorothalonil (0.05-0.1%), and potassium-rich fertilizers (2-3%) to enhance plant resilience. Regular application is vital for control.";
            case "Tomato___Septoria_leaf_spot":
                return "Remove infected leaves, avoid water splash on leaves, and apply fungicides.Chemical remedies for Tomato Septoria Leaf Spot include copper-based fungicides (1-2%), systemic fungicides such as chlorothalonil (0.05-0.1%), and potassium-rich fertilizers (2-3%) to bolster plant immunity. Consistent application is essential for effectiveness.";
            ...
            case "Tomato___Target_Spot":
                return "Rotate crops, use clean seeds, and apply fungicides as needed.Chemical remedies for Tomato Target Spot include copper-based fungicides (1-2%), systemic fungicides like azoxystrobin (0.05-0.1%), and balanced fertilizers with higher potassium content (2-3%) to fortify plant defenses. Regular application is key.";
            case "Tomato___Tomato_Yellow_Leaf_Curl_Virus":
                return "Control whitefly populations and remove infected plants.Chemical remedies for Tomato Yellow Leaf Curl Virus include systemic insecticides like acetamiprid (0.05-0.1%), copper-based fungicides (1-2%), and potassium fertilizers (2-3%) to enhance plant resilience. Regular and timely application is essential.";
            case "Tomato___Tomato_mosaic_virus":
                return "Remove and destroy infected plants, disinfect gardening tools, and avoid smoking around plants.Remedies for Tomato Mosaic Virus include copper-based fungicides (1-2% concentration), systemic insecticides like imidacloprid (0.05-0.1%), and potassium fertilizers (2-3%) to boost plant immunity. Regular application is crucial for efficacy.";
